...
description='news'
video_title=f'{ticker}_{company_name}_{today1}'
print('done 2') 
while True:
    try:
...
concatenated_audio
#%%
concat_audio_path=f'data/audios/{ticker}/test.mp3'
#%%

concatenated_audio.write_audiofile(concat_audio_path)
#%%
concat_audio_path=f'data/audios/{ticker}/a1.mp3'
audio_clip=AudioFileClip(concat_audio_path)
...
video_clip.write_videofile(f'data/youtube4/{ticker}/{timestamp1}.mp4', fps=24)
...
video_clips=[]
for file in new_list:
    video_clips.append(VideoFileClip(file).resize(newsize=(640, 360)) )
video_clips
