...
news="Headline today:"+headline.text+"\n\n"+"Next news: "+submain
...
search_list=copy.deepcopy(wjslist)
audio_folder='data/audios/'
image_folder='data/news_images/'
make_inter_videos(search_list)

make_final_video(search_list)
description='news'
video_title='others'
youtube_upload(video_title,description)

#%%
list1=[item for item in list1 if len(item)>5]
list1

search_list=save_news_images(list1)
search_list
